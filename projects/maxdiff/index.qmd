...
/* Constrain this theater to a rectangular aspect so visitors don't scroll inside it.
...
#gs-theater-md .md-figs-grid { max-width: 440px; gap: 4px; }
...
/* On phones: drop the aspect ratio (which would be too short) and use a tall-enough min-height */
...
/* In fullscreen, let the screen fill the viewport naturally */
