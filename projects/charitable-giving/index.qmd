...
function initTheater() {
  ...
  var scenes = [
    ...
    function() {
      ...
      gsap.fromTo('.gs-match-item', { y: 20, opacity: 0 }, { y: 0, opacity: 1, duration: 0.4, stagger: 0.15, ease: 'back.out(1.3)', delay: 0.2 });
      gsap.fromTo('.gs-match-plus, .gs-match-equals', { scale: 0 }, { scale: 1, duration: 0.3, stagger: 0.1, ease: 'back.out(2)', delay: 0.5 });
    },
    function() {
    ...
    function() {
      ...
      gsap.fromTo('.gs-ratio-col', { y: 30, opacity: 0 }, { y: 0, opacity: 1, duration: 0.5, stagger: 0.2, ease: 'back.out(1.3)', delay: 0.2 });
      gsap.fromTo('.gs-coin-disc', { scale: 0 }, { scale: 1, duration: 0.2, stagger: 0.05, ease: 'back.out(2)', delay: 0.4 });
    },
    function() {
    ...
    function() {
      ...
      for (var b = 1; b <= 3; b++) {
        (function(idx) {
          ...
          var counter = { v: 0 };
          gsap.to(bar, { height: (val / maxH * 100) + '%', duration: 1, ease: 'power2.out', delay: 0.2 + idx * 0.15 });
          gsap.to(counter, { v: val, duration: 1, ease: 'power2.out', delay: 0.2 + idx * 0.15,
            onUpdate: function() { pctEl.textContent = counter.v.toFixed(2) + '%'; }
          });
        })(b);
      }
      gsap.to('#gs-nolift', { opacity: 1, duration: 0.5, delay: 1.6 });
    },
    function() {
