...
function initTheater() {
  ...
  var scenes = [
    function() {
      showCharacter('../../assets/c1.svg', 'Let me tell you about an experiment that sent 50,000 letters to real donors.');
    },
    function() {
      var envHtml = '';
      for (var i = 0; i < 24; i++) {
    ...
    function() {
      showCharacter('../../assets/c2.svg', 'Two-thirds of letters included a match offer. The rest did not.');
    },
    function() {
      screen.innerHTML = '<div class="gs-act-wrap">' +
    ...
    function() {
      showCharacter('../../assets/c1.svg', 'Fundraisers swear bigger matches work harder. Is a 3-to-1 match three times as persuasive?');
    },
    function() {
      screen.innerHTML = '<div class="gs-act-wrap">' +
    ...
    function() {
      showCharacter('../../assets/c2.svg', 'Let us see how many donors responded to each one.');
    },
    function() {
      screen.innerHTML = '<div class="gs-act-wrap">' +
    ...
    function() {
      showVerdict('../../assets/c1.svg', 'Match works.',
...
plt.tight_layout()
plt.savefig('../../assets/charitable-giving-response-rate.png', dpi=120, bbox_inches='tight', facecolor='white')
plt.show()
```
...
(function() {
  ...
  function runRedBlue() {
    ...
    takeaways.forEach(function(el, i) {
      gsap.fromTo(el,
        { opacity: 0, y: 10 },
        { opacity: 1, y: 0, duration: 0.5, delay: 1.8 + i * 0.2 }
      );
    });
  }
  ...
  setTimeout(function() { runRedBlue(); }, 3000);
})();
</script>
```
