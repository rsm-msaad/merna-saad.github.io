...
.cl-viewer:-webkit-full-screen .cl-notes-wrap {
  position: absolute; left: 50%; bottom: 92px; transform: translateX(-50%);
  width: min(880px, 92vw); margin: 0; z-index: 10;
}
...
.cl-section-btn {
  ...
  cursor: pointer; transition: color 0.18s ease, border-color 0.18s ease, box-shadow 0.18s ease;
  white-space: nowrap;
  overflow: hidden;
  isolation: isolate;
}
...
.cl-section-btn.has-fill { color: #faf6ef; border-color: #2c3e50; }
.cl-section-btn.full-fill .cl-section-fill { border-radius: 999px; }
