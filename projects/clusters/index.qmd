...
@media (max-width: 720px) {
  ...
  .cl-viewer-stage { min-height: 320px; }
  .cl-slide img, .cl-slide picture { max-height: 56vh; }
    ...
    stage.innerHTML =
      '<div class="cl-slide" id="cl-slide-img">' +
        '<picture>' +
          ...
          '<img src="' + base + p.png + '" alt="Panel ' + (n+1) + '" loading="' + loading + '" />' +
        '</picture>' +
        extra +
      '</div>';
    if (hasGsap) {
